...
# ax4 = ax.twinx()  # Create another axes that shares the same x-axis as ax.
...
# df.full_predict_time.plot(kind='bar', color='r', ax=ax, width=width, position=2, label='full_predict')
df.early_train_time.plot(kind='bar', color='g', ax=ax, width=width, position=0, label='early_train')
# df.early_predict_time.plot(kind='bar', color='c', ax=ax, width=width, position=-1, label='early_predict')
#
    # algorithm,
    # full_train_time,full_predict_time,
    # full_y_train_accuracy,full_y_test_accuracy,
    # early_train_time,early_predict_time,
    # early_y_train_accuracy,early_y_test_accuracy
...
# ax2.set_ylabel('predict_time')
# ax3.set_ylabel('early_train_time')
# ax4.set_ylabel('early_predict_time')
#
# # ax2.set_ylim(0, 1)
#
...
# ax4.yaxis.label.set_color(color="c")
