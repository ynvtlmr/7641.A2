...
# X_train = one_hot.fit_transform(X_train).todense()
# X_test = one_hot.transform(X_test).todense()
...
for a in algorithms:
    for i in range(13):
        ...
        full_run.append([a, i, max_iter, max_iter,
        ...
        early_quit.append([a, i, max_iter, max_attempts,
                           train_time, predict_time,
                           y_train_accuracy, y_test_accuracy])
